...
class _SavedDocumentsState extends State<SavedDocuments> {
  ...
  void _showErrorSnackBar(String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(message), backgroundColor: AppColors.compulsory),
    );
  }

  void _showSuccessSnackBar(String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(message), backgroundColor: AppColors.vibrantgreen),
    );
  }
  ...
  Widget _dataCell(Widget child) {
    return Padding(padding: EdgeInsets.all(8.r), child: Center(child: child));
  }
                      ...
                      child: SingleChildScrollView(
                        child: Table(
                          ...
                          columnWidths: const {
                            ...
                            2: FixedColumnWidth(70), // Date
                            3: FixedColumnWidth(70), // View
                            4: FixedColumnWidth(85), // Download
                            5: FixedColumnWidth(70), // Delete
                          },
                          children: [
                            // Header row
                            TableRow(
                            ...
                            // Data rows
                            ...List.generate(_savedDocuments.length, (index) {
